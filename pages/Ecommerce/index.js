  ...
  return (
    <div>
      ...
      <section className="colorful-background">
        ...
        <div className="sobreEquipe row justify-content-center">
            <div class="col-12 col-md-8 centralizado">
              <h2 className="sobreEquipe-title"> Descubra Nossos Novos Sabores!</h2>
              <p className="sobreEquipe-Conteudo mt-n3">A equipe Alpha Develop está ansiosa para revelar os resultados de seu esforço conjunto. Eles ressaltam a contribuição de cada membro e expressam orgulho pelo progresso alcançado. Venha conferir mais detalhes sobre nossa equipe!</p>
              <div className="buttons">
            <button onClick={saibaMore} className="saiba-mais-button">Saiba mais</button>
          </div>
          </div>
          </div>
      </section>
            ...
            <div className="col-md-3 faleConosco WIDTH">
              <div className="useful-link">
                ...
                <div className="use-links">
                  ...
                  <li><a target="_blank" href=""><i class="bi bi-linkedin"></i>Ana Luiza</a></li>
                  <li><a target="_blank" href="https://www.linkedin.com/in/gustavo-marcolino-38b1152b9/"><i class="bi bi-linkedin"></i>Gustavo Marcolino</a></li>
                  <li><a target="_blank" href="https://www.linkedin.com/in/samuel-nunes-basilio-b941172b9/"><i class="bi bi-linkedin"></i>Samuel Nunes</a></li>
                  <li><a target="_blank" href=""><i class="bi bi-linkedin"></i>Evandro Miguel</a></li>
                  <li><a target="_blank" href=""><i class="bi bi-linkedin"></i>Felipe da Luz</a></li>
                  <li><a target="_blank" href=""><i class="bi bi-linkedin"></i>Matheus Oliveira</a></li>
                  <li><a target="_blank" href=""><i class="bi bi-linkedin"></i>Thainá Cortez</a></li>
                  <li><a target="_blank" href=""><i class="bi bi-linkedin"></i>Catarina Benedicto</a></li>
                </div>
              </div>
            </div>
